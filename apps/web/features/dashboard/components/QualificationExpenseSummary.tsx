import type { QualificationExpenseItem } from "../types/dashboard.types";
import {
  formatDashboardAmount,
  formatDashboardPercentage,
} from "../utils/dashboard-formatters";

type QualificationExpenseSummaryProps = {
  items: QualificationExpenseItem[];
};

export function QualificationExpenseSummary({ items }: QualificationExpenseSummaryProps) {
  return (
    <section className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
      <h2 className="text-lg font-semibold text-slate-900">Saídas por qualificação</h2>
